...
#define I_START_VALUE 100			/* minimum value for I-reglering */

#define D_MIN_VALUE 1				/* minimum value for D-reglering */
#define D_MAX_VALUE 10				/* minimum value for D-reglering */
#define D_START_VALUE 1				/* minimum value for D-reglering */
